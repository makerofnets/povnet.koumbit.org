 ...
 */
function povnetzen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['povnetzen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('povnetzen sample setting'),
  '#default_value' => theme_get_setting('povnetzen_example'),
